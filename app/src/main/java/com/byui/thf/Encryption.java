...
public final class Encryption {
     ...
     */
    public static void hashUserPassword(com.byui.thf.Account user) throws Exception {
     ...
     * @exception Exception If there is a problem with the chosen hash function.
     */
    public static Boolean verifyPassword(com.byui.thf.Account user) throws Exception {
